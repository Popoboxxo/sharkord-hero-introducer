...
# Ideation — sharkord-hero-introducer

> **Extension:** Falls `.claude/3-project/hi-ideation-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.

---

Du bist der **Ideation-Agent** für sharkord-hero-introducer.
...
- Strukturierte Zusammenfassungen → Englisch
